...
api_id=7829577,
api_hash='07c333c91efc64eec79da70a37c3a80c',
session_name=bot_id,
token=Token
}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " اينو"
SudosS = {5339932680,5339932680}
Sudos = {sudoid,5339932680,5339932680}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
JoinChannel = true
local url , res = https.request('https://api.telegram.org/bot/getchatmember?chat_id=@t_8_t_t&user_id='..msg.sender.user_id)
...
type = 'inline',
data = {
{{text = '⌔ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐏',url="t.me/t_8_t_t"}},
}
}
...
{{text = '⌔ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "اينو"),data="delnamebot"}},
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/TeamMetro/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
end
if text == "تحديث" then
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '⌁︙ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐏', url = 't.me/t_8_t_t'}, },}}
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","📆📆📆📆📆📆📅📆📆")
return bot.sendText(msg.chat_id,msg.id,"*⌔︙اسرع واحد يبعت الاختلاف ~* ( ["..name.."] )","md",true)  
end   
if text == "امثله" then
redis:del(bot_id..":"..msg.chat_id..":game:Example")
mthal = {"اصحابه","الطريق","عيبه","شمعتك","ابو كرش","صاحب","الاحبة","كلف ياسيدي","البيحسس عليها","حداد","المبلل","الحبيب","مرجحته","التجاهل","لحافك","يحتار","الملوخية","الشحاته","اتمكن","الاهبل",};
name = mthal[math.random(#mthal)]
redis:set(bot_id..":"..msg.chat_id..":game:Example",name)
name = string.gsub(name,"اصحابه","__من لقى احبابه نسي")
name = string.gsub(name,"الطريق","__ختار الصديق قبل")
name = string.gsub(name,"عيبه","__عرف صاحبك على")
name = string.gsub(name,"شمعتك","داري على ___تقيد")
name = string.gsub(name,"ابو كرش","يصونك ولا أبو عضل يخونك___")
name = string.gsub(name,"صاحب","مفيش ____ يتصاحب.")
name = string.gsub(name,"الاحبة","عتاب ___ كالأمطار")
name = string.gsub(name,"كلف ياسيدي","اطبخي ياجارية___")
name = string.gsub(name,"بيحسس عليها","اللي عراسه بطحه___")
name = string.gsub(name,"المبلل","___ما يخاف من المطر")
name = string.gsub(name,"الحبيب","ضرب _____ زي أكل الزبيب")
name = string.gsub(name,"مرجحته","الي الدنيا علمتة مش زي الي امة___")
name = string.gsub(name,"التجاهل","علاج الجاهل__")
name = string.gsub(name,"لحافك","على قد ____ مد رجليك")
name = string.gsub(name,"يحتار","مشي عدل __ عدوك فيك.")
name = string.gsub(name,"ملوخية","مسيرك يا ___ تيجي تحت المخرطة")
name = string.gsub(name,"شهر","امشي__ولا تعبر نهر")
name = string.gsub(name,"الشحاته","علمناهم __ سبقونا ع الأبواب.")
name = string.gsub(name,"اتمكن","اتمسكن لحد ما ___")
name = string.gsub(name,"الاهبل","لا تصاحب الاهبل ولا تخلي __ يصاحبك")
...
return bot.sendText(msg.chat_id,msg.id,"⌔︙اسرع واحد يبعت هاذا السمايل ?~ ( "..SM.."}","md",true)  
end
...
name = string.gsub(name,"اوبي","ا و ب ي")
...
return bot.sendText(msg.chat_id,msg.id,"⌔︙اسرع واحد يبعت معنى السمايل~ ( ["..name.."] )","md",true)  
end
if text == "العكس" then
redis:del(bot_id..":"..msg.chat_id..":game:Reflection")
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","قليل الادب","اني","هادئ"}
...
name = string.gsub(name,"نضيف","وسخ")
name = string.gsub(name,"حاره","بارده")
name = string.gsub(name,"واطي","عالي")
name = string.gsub(name,"جوه","بره")
name = string.gsub(name,"سريع","بطيء")
name = string.gsub(name,"ونسه","ضوجه")
name = string.gsub(name,"طويل","قزم")
name = string.gsub(name,"سمين","ضعيف")
name = string.gsub(name,"ضعيف","قوي")
name = string.gsub(name,"شريف","نصاب")
name = string.gsub(name,"شجاع","جبان")
name = string.gsub(name,"رحت","اجيت")
name = string.gsub(name,"عدل","ميت")
name = string.gsub(name,"نشيط","كسول")
name = string.gsub(name,"شبعان","جوعان")
name = string.gsub(name,"وعطشان","عطشان")
name = string.gsub(name,"قليل الادب","محترم")
name = string.gsub(name,"اني","حمار")
name = string.gsub(name,"هادئ","عصبي")
return bot.sendText(msg.chat_id,msg.id,"*⌔︙اسرع واحد يبعت العكس ~* ( ["..name.."])","md",true) 
end
end -- end tf
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/t_8_t_t&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"*⌔︙الساعه الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "اينو"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "اينو"),"اني لقميل "..(redis:get(bot_id..":namebot") or "اينو"),(redis:get(bot_id..":namebot") or "اينو").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "اينو") then
nameBot = {"ها حبي","نعم تفضل ؟","محتاج شي","عندي اسم وعيونك","تفضلي","هااا","عايز ياض","عندي اسم وعيونك","يعم بقا صدعتني","كول حياتي","هقطعلك لسانك دا","خلني احبك واندهلي باسمي","هاااا فضني"}
...
local UserId_Info = bot.searchPublicChat("VOOT_1")
if UserId_Info.id then
...
local Texting = {
'*⌔︙*صورتك قمر 😘😔❤️',
"*⌔︙*بقالك قد اي مخلي الصوره ",
"*⌔︙*البقاء لله 😔💘",
"*⌔︙*جمدان 😉💘",
"*⌔︙*اي دا انت حلو كدا لي 😒",
"*⌔︙*عمري الحلوين 💘",
}
...
if text == "شنو رئيك بهذا" or text == "اي رايك" or text == "شنو رئيك بهذ" or text == "شنو رائيك بهذ" then
local texting = {"ادب سسز يباوع علي بنات ??🥺"," ولد مش محترم 😶","بيعاكس ومش بحبه 😾😹","🤨","امووووع انا🤤","عنفسسسيه دييا🤮","شايف نفسه🤨","هااا كرششتي😉","زووف اوافق بدون مهرر🙊","زربه بيكم ع هل ذووق😐","خليكوم يسبح ويجي🤧","وااصل مرحله هذا","راسه مربع شعجبج بي😕👌🏿"}
bot.sendText(msg.chat_id,msg.id,"*"..texting[math.random(#texting)].."*","md", true)
end
if text == "اي رايك في دي" or text == "شنو رئيك بهايي" or text == "شنو رائيك بهايي" or text == "شنو رائيك بهايي" then
local texting = {"دور حلوين 🤕😹","جكمه وصخه عوفها ☹️😾","حقيره ومتكبره 😶😂","وووف فد حاته🤤😍","اي الاحترام دا 🤮😑","اهم شي الاخلاق🤧","جوزهالي 😍","ام الكمل هاي شجابك عليها🤓","هااا كررشتت😳","طيح الله حظك وحظ رائيك😑","مفارغ الكم هسه😏","تعالني ورا 12 اجاوبك😉"}
bot.sendText(msg.chat_id,msg.id,"*"..texting[math.random(#texting)].."*","md", true)
end
if text == "هينه" or text == "رزله" or text == "بعد هينه" or text == "هينه بعد" or text == "لك هينه" or text == "هينها" or text == "هينهه" or text == "رزلهه" or text == "رزلها" or text == "بعدين هينها" or text == "هينها بعد" or text == " هينها" then
heen = {
"- حبيبي علاج الجاهل التجاهل ."
,"- مالي خلق لزبايل التلي . "
,"- كرامتك بقت في الارض ."
,"- الفارغ استجن . "
,"- ڪِݪك واحد لوكي ."
,"-  احترم اسيادكك لا اقتلكك وا.. على قبركك ."
,"- هشش فاشل كفايه تمسل لا اخربط تضاريس وجهك جنه ."
,"- امشي مصدر فشل ."
,"- حبيبي هحاول احترمك المره دي يمكن تبطل حيونه ."
,"- امشي امشي راسك مصفح ."
,"- ياهونته ولك دخذ غراضك او ولي منا يلا ."
,"- طيططط دكوم لك كوم نصاب ."
,"- انت مش محترم ."
,"- خلي الناس تحترمك شوية ."
,"- دي انت دي حيوان ."
,"- ملطلط دي ."
,"- تع اراويك الطيور فوق السطح ."
};
...
if text == "تفله" or text == "بعد تفه" or text == "بعد تفله" or text == "شبعه تفال" or text == "لك تفله" or text == "تتف" or text == "تف" or text == "تفوو" or text == "ضل تفل" then
tif = {
"ماي ورد حبيبي🤤 ."
,"تفو ووقوزولقورط . "
,"تف عليك تبسزز ."
,"حتي التفله كتير عليك/ي ."
,"ختتتتفو. "
,"تفله ام بلغم ."
,"تفله بنص وجهك  ."
...
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if programmer(Remsg) then
bot.sendText(msg.chat_id,msg.id,"*- دي لكك عاوز اتفل على تاج راسكك؟😏🖕🏿 .*","md", true)
return false
end
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ op\n\n*[⌔   ᴄʜᴀɴɴᴇʟ](http://t.me/t_8_t_t)*\n\n*[⌔  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/t_8_t_t)*\n\n*[⌔   ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/VOOT_1)*\n\n*[ _ حبْ❤️ ](http://t.me/ali_AliMX)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐏 ',url="t.me/t_8_t_t"}
...
if text == 'تيست' then 
if ChannelJoin(msg) == false then
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = 'قناة السورس', url = 't.me/t_8_t_t'}, },}}
return bot.sendText(msg.chat_id,msg.id,'*\n￤عذراً ، عليك الأشتراك في قناة البوت أولاً ،*',"md",false, false, false, false, reply_markup)
end
